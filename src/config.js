...
export const LOCAL_STORAGE_KEY_HORROR = 'react-filmfavs-data--horror';
export const LOCAL_STORAGE_KEY_ROMANCE = 'react-filmfavs-data--romance';
export const LOCAL_STORAGE_KEY_FAVS = 'react-filmfavs-data--favs';
